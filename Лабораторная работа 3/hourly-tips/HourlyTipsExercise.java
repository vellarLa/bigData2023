...
public class HourlyTipsExercise {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        DataStream<Tuple3<Long, Long, Float>> hourTips = fares
                .keyBy((fare) -> fare.driverId)
                .window(TumblingEventTimeWindows.of(Time.hours(1)))
                .process(new ComputeTips());
        DataStream<Tuple3<Long, Long, Float>> hourlyMax = hourTips.windowAll(TumblingEventTimeWindows.of(Time.hours(1))).maxBy(2);
    ...
    public static class ComputeTips extends ProcessWindowFunction<TaxiFare, Tuple3<Long, Long, Float>, Long, TimeWindow> {
        @Override
